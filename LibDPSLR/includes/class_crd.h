...
public:
    ...
    struct PredictionHeader : dpslr::common::ConsolidatedRecordStruct
    {
        ...
        dpslr::common::HRTimePoint datetime;      // CPF: starting datetime MMDDHH as in cpf H2 /  TLE: Field 8 (Epoch)
...
public:
    ...
    struct SoftwareConfiguration : dpslr::common::ConsolidatedRecordStruct
    {
        ...
        std::string tracking_sw;         // Tracking software. Can be more than one, comma separated.
        std::string tracking_sw_ver;     // Version of tracking software.
        std::string processing_sw;       // Processing software. Can be more than one, comma separated.
        std::string processing_sw_ver;   // Version of processing software.
        // Functions.
        std::string generateLine(float version) const;
    };
    ...
    struct CalibrationTargetConfiguration : dpslr::common::ConsolidatedRecordStruct
    {
        // Members.
        unsigned int detail;                     // Always 0
        ...
        dpslr::common::optional<double> error;   // Surveyed distance error (mm)
        dpslr::common::optional<double> delays;  // Sum of constant delays not measured (m, one way)
        dpslr::common::optional<double> energy;  // Pulse energy (mJ)
        std::string processing_sw;               // Processing software. Can be more than one, comma separated.
        std::string processing_sw_ver;           // Version of processing software.
        //Functions.
        std::string generateLine(float version) const;
    ...
    const dpslr::common::optional<CalibrationTargetConfiguration> &calibrationConfiguration() const;
    ...
    dpslr::common::optional<CalibrationTargetConfiguration> &calibrationConfiguration();
...
private:
    ...
    dpslr::common::optional<CalibrationTargetConfiguration> calib_target_cfg;
};
// =====================================================================================================================
