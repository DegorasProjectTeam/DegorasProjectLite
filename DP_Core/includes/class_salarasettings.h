...
class SP_CORE_EXPORT SalaraSettings
{
public:
    ...
    // Seters.
    SalaraInformation setGlobalConfig(const QString& path);
    SalaraInformation setApplicationConfig(const QString& path);
    SalaraInformation setStationData(const QString& path);
    ...
    // Singleton instance.
    static SalaraSettings& instance();
...
private:
    SalaraSettings() = default;
    ~SalaraSettings();
    SalaraSettings(const SalaraSettings&) = delete;
    SalaraSettings& operator=(const SalaraSettings&) = delete;
    SalaraSettings(SalaraSettings&&) = delete;
    SalaraSettings& operator=(SalaraSettings&&) = delete;
};
